...
export default function MetaMaskAuth({ onAddressChanged }) {
  ...
  return userAddress ? (
    <div className="text-white cursor-pointer bg-[#FF9119] hover:bg-[#FF9119]/80 focus:ring-4 focus:outline-none focus:ring-[#FF9119]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 mr-2 mb-2">
...
function Connect({ setUserAddress }) {
  ...
  return (
    <button
      ...
      type="button"
      className="text-white text-center bg-[#FF9119] hover:bg-[#FF9119]/80 focus:ring-4 focus:outline-none focus:ring-[#FF9119]/50 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex  items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 mr-2 mb-2"
    >
      <svg
        aria-hidden="true"
